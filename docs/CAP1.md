...
**En escritura.** Estructura cerrada, apertura terminada, cinco eventos de hub y
evento final pendientes de guion.
...
| `yotsuba_incomoda` | sprite | apertura, escena 2 | pendiente |
| `nino_pillada` | sprite | apertura, escena 2 | pendiente |
...
| biblioteca | BG | evento Miku + preparar material | pendiente |
...
- Los cinco eventos de hermana, a nivel de escena
